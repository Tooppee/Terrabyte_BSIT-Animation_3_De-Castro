    ...
    if (isset($_GET['remove'])) {
        ...
        mysqli_query($conn, "DELETE FROM `product` WHERE `product_ID` = '$remove_id'");
    ...
    <body>
        ...
        <div class="content">
            ...
            <div>
                <table class="table full-width-table table-bordered table-hover custom-table">
                    ...
                    <?php
                        //Fetching all products from the product database
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <!--Edit-->
                                <a href="admin_products.php?edit=<?php echo $row['product_ID']; ?>" class="edit-btn" data-bs-toggle="modal" data-bs-target="#secondmodal">
                                    <img src="images/Edit.jpg" alt="Edit" style="width: 24px; height: 24px;">
                                </a>
                                <!--Remove-->
                                <a href="admin_products.php?remove=<?php echo $row['product_ID']; ?>" onclick='return confirm("Are you sure you want to remove this product?");' class="btn">
        ...
        <button type="button" class="add-btn rounded" data-bs-toggle="modal" data-bs-target="#firstmodal" 
                style="margin-left: 300px; margin-bottom: 30px; text-decoration: none; width: 200px;">
            Add Product
        </button>
